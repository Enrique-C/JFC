...
public enum ErrorMessageJfc {
    ...
    INVALID_SCALE("Invalid Scale value."),
    ...
    VIDEOCODEC_NOT_CHANGE("Can not change the Video ."),
    VIDEO_NOT_CONVERTED("Can not convert a video."),
    FORMTAT_INVALID("The format is invalid."),
    ...
    WIDTH_INVALID("Width cannot be less than 128."),
    HEIGHT_INVALID("Height cannot be less than 128."),
