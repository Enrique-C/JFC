...
RPMS(또는 DEBS) 디렉터리에도 libreoffice6.3-freedesktop-menus-6.3.0.1-1.noarch.rpm (또는 libreoffice6.3-debian-menus_6.3.0.1-1_all.deb) 이라는 패키지가 있습니다. 이 패키지는 Freedesktop.org 기술 사양/추천 (https://en.wikipedia.org/wiki/Freedesktop.org) 내용을 지원하는 모든 리눅스 배포판을 위한 패키지입니다. 그리고 앞서 기술한 설치 방법을 지원하지 않는 다른 리눅스 배포판을 위한 설치 방법도 제공합니다.
...
우리는 여러분이 LibreOffice 6.3을 위해 일하는 것을 즐기기 바라며 온라인으로 함께 참여하기를 희망합니다.
