...
The RPMS (or DEBS, respectively) directory also contains a package named libreoffice6.3-freedesktop-menus-6.3.0.1-1.noarch.rpm (or libreoffice6.3-debian-menus_6.3.0.1-1_all.deb, respectively, or similar). This is a package for all Linux distributions that support the Freedesktop.org specifications/recommendations (https://en.wikipedia.org/wiki/Freedesktop.org), and is provided for installation on other Linux distributions not covered in the aforementioned instructions.
...
We hope you enjoy working with the new LibreOffice 6.3 and will join us online.
