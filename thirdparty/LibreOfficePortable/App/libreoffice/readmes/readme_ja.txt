...
RPM (やDEBSなど) のディレクトリには libreoffice6.3-freedesktop-menus-6.3.0.1-1.noarch.rpm (あるいは libreoffice6.3-debian-menus_6.3.0.1-1_all.debなど) というパッケージもあります。これは Freedesktop.org specifications/recommendations (https://en.wikipedia.org/wiki/Freedesktop.org)に対応している全ての Linux ディストリビューションのためのパッケージで、上で述べた説明で扱っていない他の Linux ディストリビューションでのインストールのために提供されています。
...
新しい LibreOffice 6.3 をどうぞお楽しみください。そして、オンラインコミュニティに参加していただけることを願っています。
